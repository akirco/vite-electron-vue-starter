<template>
  <div class="w-full h-full" id="box">
    <div id="input_enhance" class="p-3">
      <div id="select_enhance" class="border-2 border-dashed border-dark-50 dark:border-gray-700">
        ...
        <div class="text-gray-600 grid grid-rows-2">
          <div class="p-4">
            <input type="radio" id="one" v-model="model" value="realesrgan-x4plus" class="radio radio-primary" /><br />
            <label for="one">4k默认</label>
          </div>
          <div class="p-4">
            <input type="radio" id="two" v-model="model" value="realesrgan-x4plus-anime"
              class="radio radio-primary" /><br />
      ...
      <div id="operate_enhance" class="border-2 border-dashed border-dark-50 dark:border-gray-700">
        ...
        <div class="flex justify-center items-center">
          <button @click="startEnhance" class="btn gap-2 btn-accent dark:text-gray-700" :disabled="!imgPathList.length">
    ...
    <div id="preview">
      <div class="border-2 border-dashed border-dark-50 dark:border-gray-700 rounded-xl shadow-xl p-2 preimg"
        id="before" :style="{ backgroundImage: 'url(atom:///home/meta/Pictures/1.png)' }"></div>
      <div class="p-2 preimg" id="divder"></div>
      <div class="border-2 border-dashed border-dark-50 dark:border-gray-700 rounded-xl shadow-xl p-2 preimg" id="after"
        :style="{ backgroundImage: 'url(atom:///home/meta/Pictures/1.png)' }"></div>
    </div>
  </div>
</template>
...
const startEnhance = async () => {
  await ipcRenderer.sendSync("setModel", model.value);
  await ipcRenderer.invoke("startEhance");
}
</script>
